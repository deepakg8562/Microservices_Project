package com.deloitte.bankingApplication.entity;
...
@Entity
@Table(name = "transactions", schema = "online_Bank")
...
public class Transaction {
	...
	public String toString() {
		return "Transaction{" + "sourceAccountId=" + sourceAccountId + ", targetAccountId=" + targetAccountId
				+ ", targetOwnerName='" + targetOwnerName + '\'' + ", amount=" + amount + ", initiationDate="
				+ initiationDate + ", completionDate=" + completionDate + ", reference='" + reference + '\'' + '}';
	}
}
